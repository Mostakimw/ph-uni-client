...
import AllStudents from "../pages/admin/userManagement/Student/AllStudents";
...
//   ! create routes using reducer function, so that i just need to change the adminpaths text
